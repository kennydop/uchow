...
class _SignInState extends State<SignIn> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => userController.loading == false.obs &&
            userController.user.token.isEmpty
        ? Scaffold(
        ...
        : userController.loading == true.obs
            ? const Scaffold(
                backgroundColor: AppColors.bgColor,
                body: Center(
            ...
            : const Scaffold(backgroundColor: AppColors.bgColor));
  }
}
