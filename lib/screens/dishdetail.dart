      ...
      body: SingleChildScrollView(
        child: Stack(children: [
            ...
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.vertical(
                              bottom: Radius.circular(AppDimensions.height24)),
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        width: addedToCart
                            ? AppDimensions.height48
                            : AppDimensions.width100,
                        decoration: BoxDecoration(
                            color: addedToCart
              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      AppText(
                        text: "Reviews (" + dishReviews.length.toString() + ")",
                      ),
          ...
          Container(
            ...
            margin: EdgeInsets.symmetric(horizontal: AppMargin.horizontal),
            child: SafeArea(
              child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
